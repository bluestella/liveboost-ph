      ...
      <section className="min-h-[90vh] flex items-center bg-gradient-to-br from-blue-100 via-white to-white">
        <div className="mx-auto max-w-6xl px-4 py-20 text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link href="/pricing" className="rounded-md bg-orange-500 text-white px-6 py-3 font-semibold hover:bg-orange-600 flex items-center gap-2">
              View Plans <ArrowRight className="h-4 w-4" />
            </Link>
            <a href="#about" className="rounded-md border px-6 py-3 font-semibold text-gray-800 hover:bg-gray-50">
              Learn More
            </a>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <ol className="mt-8 grid md:grid-cols-5 gap-4 text-sm">
            {["Choose Your Plan","Sign Up & Pay","Share Your Details","Setup Call","Go Live"].map((step, i) => (
              <li key={step} className="rounded-md border bg-white p-4 text-center shadow">
          ...
          <div className="mt-8 text-center">
            <Link href="/pricing" className="rounded-md bg-orange-500 text-white px-6 py-3 font-semibold hover:bg-orange-600">View Our Plans</Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[1,2,3].map((i) => (
              <div key={i} className="rounded-xl border bg-white p-6 shadow">
      ...
      <section className="bg-gradient-to-r from-blue-100 to-blue-200">
        <div className="mx-auto max-w-6xl px-4 py-16 text-center">
          ...
          <div className="mt-6 flex justify-center">
            <Link href="/pricing" className="rounded-md bg-orange-500 text-white px-6 py-3 font-semibold hover:bg-orange-600">Get Started Today</Link>
          </div>
        </div>
      </section>
    </div>
